...
export function LoginPage() {
  return (
    ...
    >
      <Header />
      <section>
        <div className="flex flex-col items-center justify-center mx-auto lg:py-32">
          <div className="w-full bg-white rounded-3xl md:mt-0 sm:max-w-md p-5 bg-opacity-90 border">
